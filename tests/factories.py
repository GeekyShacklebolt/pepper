...
def create_facebook_page(**kwargs):
    return G(apps.get_model('facebook.FacebookPage'), **kwargs)


def create_messenger_label(**kwargs):
    return G(apps.get_model('facebook.MessengerLabel'), **kwargs)


def create_psid_list(**kwargs):
    return G(apps.get_model('facebook.PSIDList'), **kwargs)
